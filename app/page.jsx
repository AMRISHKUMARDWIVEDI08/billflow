...
export default function Home() {
  ...
  const createRequest = async () => {
    ...
    try {
      ...
      const signature = await signMessageAsync({ message: requestMessage(payload) });
      ...
      setNotice(error?.shortMessage || error?.message || "request signature was rejected.");
    } finally {
      setBusy(false);
    }
  };
